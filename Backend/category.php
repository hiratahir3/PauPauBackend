...
<section class="products">
   ...
   <a href="category.php?category=edibleoils">edible oils</a>
   <a href="category.php?category=personalcare">personal care</a>
   ...
   <form action="" class="box" method="POST">
      ...
      <img src="uploaded_img/<?= $fetch_products['image']; ?>" width="40" height="150" alt="">
